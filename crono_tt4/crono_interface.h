...
// The current driver version for Ndigo devices is 1.3.1.0
// The current driver version for xTDC4/TimeTagger4 devices is 1.3.1.0
//
...
#define CRONO_DEVICE_NDIGO2G14		11
